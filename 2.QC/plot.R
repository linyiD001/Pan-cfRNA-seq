...
p4<-ggplot(QCofseq_summary, aes(x = TYPE, y = `gene number(ensg)`, fill = TYPE)) +
  ...
  theme_light(base_size=10)+
  theme_classic()
ggsave("gene_number(ensg).png", plot = p4, width = 4, height = 4, units = "in", dpi = 300)
ggsave("gene_number(ensg).pdf", plot = p4, width = 4, height = 4, dpi = 300)
...
p6
ggsave("ERCC_cor.png", plot = p6, width = 4, height = 4, units = "in", dpi = 300)
ggsave("ERCC_cor.pdf", plot = p6, width = 4, height = 4, units = "in", dpi = 300)
...
p8<-ggplot(QCofseq_summary, aes(x = TYPE, y =  `total map%`, fill = TYPE)) +
  ...
  theme_light(base_size=10)+
  theme_classic()
ggsave("total_map_percentage.png", plot = p8, width = 4, height = 4, units = "in", dpi = 300)
ggsave("total_map_percentage.pdf", plot = p8, width = 4, height = 4, units = "in", dpi = 300)
...
ggsave("density_ERCC_cor.png", plot = p9, width = 4, height = 4, units = "in", dpi = 300)
ggsave("density_ERCC_cor.pdf", plot = p9, width = 4, height = 4, units = "in", dpi = 300)
