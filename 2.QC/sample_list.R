...
setwd("/dssg/home/acct-dahan/share/BC/cfRNA/RESULT/ANALYSIS/QC")
...
cfRNA_count<-read.csv("/dssg/home/acct-dahan/share/BC/cfRNA/RESULT/MAPPING/STAR/count.csv",header=T,row.names = 1)
tissue_count<-read.csv("/dssg/home/acct-dahan/share/BC/tissue/RESULT/MAPPING/star/unanno_count.csv",header=T,row.names = 2)
...
####add QC info
cfRNA_QC_list<-read.csv("/dssg/home/acct-dahan/share/BC/cfRNA/RESULT/ANALYSIS/QC/starstandard/QC_starstandard_list_withoutR.csv",header=T,row.names = 1)
