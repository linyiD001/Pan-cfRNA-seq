...
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome/X_C_H")
glmnet_model <- readRDS("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome/X_C_H/glmnet_model.rds")
...
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome/X_C_S")
...
ggsave("X_C_S_ROC_plot.png", g2, width = 5, height = 4, units = "in", dpi = 300)
ggsave("X_C_S_ROC_plot.pdf", g2, width = 5, height = 4, units = "in", dpi = 300)
