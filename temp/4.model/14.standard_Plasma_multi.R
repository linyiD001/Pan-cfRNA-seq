...
rm(list=ls())
set.seed(250818)
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_standard/multi_X")
...
ggsave("X_standard_Stage.png",height=8,width=12,dpi=300)
ggsave("X_standard_Stage.pdf",height=8,width=12,dpi=300)
