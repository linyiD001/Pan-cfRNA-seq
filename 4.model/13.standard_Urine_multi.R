...
rm(list=ls())
set.seed(250818)
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_standard/multi_N")

train_data<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_standard/train_data_N.csv",header=T,row.names = 1)
test_data<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_standard/test_data_N.csv",header=T,row.names = 1)
...
ggsave("N_standard_Stage.png",height=8,width=12,dpi=300)
ggsave("N_standard_Stage.pdf",height=8,width=12,dpi=300)
