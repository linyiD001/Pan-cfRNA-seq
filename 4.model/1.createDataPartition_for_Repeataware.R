...
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome")
count_N<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/DEG_repeataware/salmon_repeataware_stranded_allgenome/nor_count_N.csv",row.names = 1)
#count_N<-count_N[,-1]
count_X<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/DEG_repeataware/salmon_repeataware_stranded_allgenome/nor_count_X.csv",row.names = 1)
#count_X<-count_X[,-1]
...
###cfRNA_filter
NCH_DEG<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/DEG_repeataware/salmon_repeataware_stranded_allgenome/N_type_C_vs_H_result.csv",header=T,row.names = 1)
...
###cfRNA_filter
NCH_DEG<-read.csv("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/DEG_repeataware/salmon_repeataware_stranded_allgenome/X_type_C_vs_H_result.csv",header=T,row.names = 1)
gene_list_DEG<-subset(NCH_DEG,baseMean>10)
count_analysis_DEG<-count_analysis[which(rownames(count_analysis) %in% rownames(gene_list_DEG)),]
