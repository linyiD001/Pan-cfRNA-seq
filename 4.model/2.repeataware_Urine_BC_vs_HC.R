...
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome/N_C_H")
...
ggsave("N_C_H_ROC_plot.png", g2, width = 5, height = 4, units = "in", dpi = 300)
ggsave("N_C_H_ROC_plot.pdf", g2, width = 5, height = 4, units = "in", dpi = 300)
