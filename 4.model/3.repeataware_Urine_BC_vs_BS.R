...
setwd("/dssg/home/acct-dahan/share/cfRNA/RESULT/ANALYSIS/model/salmon_repeataware_stranded_allgenome/N_C_S")
...
idx_H<-which(train_data$outcome=='1')
train_data<-train_data[-idx_H,]

idx_H<-which(test_data$outcome=='1')
test_data<-test_data[-idx_H,]
...
ggsave("N_C_S_ROC_plot.png", g2, width = 5, height = 4, units = "in", dpi = 300)
ggsave("N_C_S_ROC_plot.pdf", g2, width = 5, height = 4, units = "in", dpi = 300)
