...
setwd("/dssg/home/acct-dahan/share/BC/cfRNA/RESULT/ANALYSIS/model/star_standard/glmnet/N_CS")
...
ggsave("N_CS_boxplot_plot.png", boxplot_plot, width = 5, height = 4, units = "in", dpi = 300)
ggsave("N_CS_boxplot_plot.pdf", boxplot_plot, width = 5, height = 4, units = "in", dpi = 300)
